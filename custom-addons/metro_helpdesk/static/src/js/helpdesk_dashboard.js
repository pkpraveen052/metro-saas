odoo.define('metro_helpdesk.dashboard', function (require) {
"use strict";
...
var HelpdeskDashboardRenderer = KanbanRenderer.extend({
    ...
    _render: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var helpdesk_dashboard = QWeb.render('metro_helpdesk.HelpdeskDashboard', {
                widget: self,
    ...
    _onDashboardActionClicked: function (e) {
        ...
        if ($action.attr('show_demo') != 'true'){
            if ($action.attr('name').includes("metro_helpdesk.")) {
                this._rpc({
