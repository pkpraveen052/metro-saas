...
class ResConfigSettings(models.TransientModel):
    ...
    client_id = fields.Char(string="Client ID", config_parameter="assistro.client_id", default="10")
    ...
    def signup_url_action(self):
        return {
            ...
            'url': 'https://dev.app.assistro.co/register',
            'target': 'new',
        }
    ...
    def _refresh_token_logic(self):
        """
        Refresh access_token and refresh_token using the refresh_token.
        """
        self.ensure_one()
        client_id = self.client_id
        client_secret = self.client_secret
        ...
        try:
            ...
            if response.status_code == 200 and 'access_token' in response_data:
                ...
                # Save refreshed tokens in ir.config_parameter
                config_param = self.env['ir.config_parameter'].sudo()
