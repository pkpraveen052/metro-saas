...
class ProgressiveBillingCancel(models.TransientModel):
    _name = 'progressive.billing.cancel'
    _description = "Progressive Billing Cancel"

    order_id = fields.Many2one('progressive.billing.qt', string='Progressive Billing Sale Order', required=True, ondelete='cascade')
