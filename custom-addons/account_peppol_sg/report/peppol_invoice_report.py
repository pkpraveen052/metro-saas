...
from ..models import peppol_log_sg
import logging
...
class PeppolInvoiceReport(models.Model):
    ...
    status = fields.Selection(peppol_queue_out.SELECTION_PEPPOL_QUEUE_OUT_STATE+peppol_log_sg.SELECTION_PEPPOL_LOG_SG_STATE,string="Status")
