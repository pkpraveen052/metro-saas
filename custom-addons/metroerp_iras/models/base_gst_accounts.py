...
class BaseGstAccounts(models.AbstractModel):
    _name = "base.gst.accounts"
    ...
    @api.model
    def _get_account_general_ledger(self, accounts, data={}):
        print("\n_get_account_general_ledger() >>>>>")
        print("data ===",data)
        print("self.env.context ===",self.env.context)

        init_balance = data.get('init_balance') #True
        sortby = data.get('sortby') #sort_journal_partner
        display_account = data.get('display_account') #movement #not_zero

        print("accounts ==",accounts)
        print("init_balance ==",init_balance)
        print("sortby ==",sortby)
        print("display_account ==",display_account)
