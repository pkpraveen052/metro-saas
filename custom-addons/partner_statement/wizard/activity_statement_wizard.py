...
class ActivityStatementWizard(models.TransientModel):
    ...
    def _print_report(self):
        ...
        return self.env.ref("partner_statement.action_print_activity_statement").report_action(docids=partners.ids, data=data)
    ...
    def action_send_activity_statement(self):
        ...
        template = self.env.ref('partner_statement.email_template_customer_activity_statement')
        ...
        for partner in partners:
            ...
            attachment = self.env['ir.attachment'].create({
                'name': f'Activity Statement - {partner.name}.pdf',
                'type': 'binary',
                'datas': pdf_base64,
