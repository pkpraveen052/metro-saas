...
class SupplierMonthlyStatementWizard(models.TransientModel):
    _name = 'supplier.monthly.statement.wizard'
    _description = 'Supplier Monthly Statement Wizard'
    ...
    def generate_report(self):
        ...
        if self.date_from and self.date_to:
            return self.env.ref('account_statement.report_supplier_monthly_print').report_action(self.partner_id)
